<template>
  <div class="stats">
    <tabs
      v-if="playersGoalScored && playersSaves"
            ...
            <td class="table__player">
              <div class="table__player__img">
                ...
                <img
                  ...
                  :src="
                    require(`@/assets/images/flags/${props.item.countrycode.toLowerCase()}.png`)
                  "
                  alt=""
                />
              </div>
    ...
    <loading-spinner v-if="!getPlayersGoalScored && !getPlayersSaves" />
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapGetters(["getPlayersGoalScored"], ["getPlayersSaves"])
  },

  methods: {
    ...mapActions({
      fetchPlayersGoalScored: "fetchPlayersGoalScored",
      fetchPlayersSaves: "fetchPlayersSaves"
    })
  },
